...
if (filter_input(INPUT_POST, 'submit') === 'Update') {
...
$sql = 'UPDATE registration SET regFirstName=:firstname, regLastName=:lastname, regEmail=:email WHERE regId=:id';
...
<html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Update Result | Ch. 4 Revisited</title>
